        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryTag = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    ...
                    LastCode = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TagKey = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_deliveries_Status_NextAttemptAtUtc_LockedUntilUtc_CreatedAt~",
                schema: "notifications",
                table: "deliveries",
            ...
            migrationBuilder.Sql(
                ...
                ALTER TABLE notifications.deliveries
                    ...
                    ADD CONSTRAINT "CK_deliveries_Lease"
                ...
                ALTER TABLE notifications.delivery_attempts
                    ADD CONSTRAINT "CK_delivery_attempts_AttemptNumber"
                    CHECK ("AttemptNumber" >= 1),
                    ADD CONSTRAINT "CK_delivery_attempts_Timestamps"
                    CHECK ("CompletedAtUtc" >= "StartedAtUtc"),
                    ADD CONSTRAINT "CK_delivery_attempts_Outcome"
                    CHECK ("Outcome" IN ('delivered', 'retry', 'rejected', 'exception'));
                ...
                ALTER TABLE notifications.tag_definitions
                    ...
                    ADD CONSTRAINT "CK_tag_definitions_Kind" CHECK ("Kind" IN ('delivery', 'domain')),
                    ADD CONSTRAINT "CK_tag_definitions_Origin" CHECK ("Origin" IN ('system', 'module', 'operator'));
                """);
        }
