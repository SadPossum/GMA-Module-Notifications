...
namespace Gma.Modules.Notifications.Persistence.PostgreSqlMigrations.Migrations
{
    ...
    public partial class AddResumableNotificationHistoryClose : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_notification_history_batch_close_operations_notification_hi~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_notification_history_batch_close_receipts_notification_hist~",
                        columns: x => new { x.ScopeId, x.Namespace, x.Digest },
                        principalSchema: "notifications",
                        principalTable: "notification_history_reference_states",
                        principalColumns: new[] { "ScopeId", "Namespace", "Digest" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_notification_history_batch_close_operations_ScopeId_Namespa~",
                schema: "notifications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_notification_history_batch_close_receipts_ScopeId_Namespace~",
                schema: "notifications",
            ...
            migrationBuilder.Sql(
                """
                CREATE FUNCTION notifications.reject_notification_history_batch_close_receipt_mutation()
                RETURNS trigger
                LANGUAGE plpgsql
                AS $$
                BEGIN
                ...
                CREATE TRIGGER notification_history_batch_close_receipts_append_only
                BEFORE UPDATE OR DELETE
                ON notifications.notification_history_batch_close_receipts
                FOR EACH ROW
                EXECUTE FUNCTION notifications.reject_notification_history_batch_close_receipt_mutation();
                """);
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(
                """
                DROP TRIGGER IF EXISTS notification_history_batch_close_receipts_append_only
                ON notifications.notification_history_batch_close_receipts;

                DROP FUNCTION IF EXISTS
                    notifications.reject_notification_history_batch_close_receipt_mutation();
                """);
