...
namespace Gma.Modules.Notifications.Persistence.SqlServerMigrations.Migrations
{
    ...
    [Migration("20260804025247_AddNotificationScopeDestruction")]
    partial class AddNotificationScopeDestruction
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("notification_scope_destroy_operations", "notifications", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_notification_scope_destroy_operations_progress", "\"Stage\" >= 1 AND \"Stage\" <= 7 AND \"RemovedRecordCount\" >= 0 AND \"CompletedBatchCount\" >= 0 AND \"ProofVersion\" >= 1");
            ...
            modelBuilder.Entity("Gma.Modules.Notifications.Domain.Entities.NotificationScopeDestroyReceipt", b =>
                {
                    ...
                    b.ToTable("notification_scope_destroy_receipts", "notifications", t =>
                        {
                            t.HasCheckConstraint("CK_notification_scope_destroy_receipts_progress", "\"BatchSize\" >= 1 AND \"RemovedRecordCount\" >= 0 AND \"CompletedBatchCount\" >= 0 AND \"RemovalProofVersion\" >= 1");
